...
public class AgregarProducto extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (accion.equals("modificar")){
            ...
            btnregresar.setOnClickListener(view1 -> {
                Intent r = new Intent(AgregarProducto.this, Home.class);
                startActivity(r);
    ...
    private void mostrarVistaPrincipal(){
        Intent iprincipal = new Intent(getApplicationContext(), Home.class);
        ...
        protected void onPostExecute(String s) {
            ...
            try {
                ...
                if (jsonObject.getBoolean("ok")){
                    ...
                    Intent regresar = new Intent(AgregarProducto.this, Home.class);
