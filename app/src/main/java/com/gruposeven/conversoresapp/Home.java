...
public class Home extends AppCompatActivity {
    ...
    private void eliminarProducto(){
        try {
            AlertDialog.Builder confirmacion = new AlertDialog.Builder(Home.this);
    ...
    public void  nuevo_catalogo(){
        Intent agregar_catalogo = new Intent(Home.this, AgregarProducto.class);
    ...
    private class obtenerDatos extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String s) {
            ...
            try {
                ...
                final ArrayAdapter<String> aaAgenda = new ArrayAdapter<String>(Home.this, android.R.layout.simple_list_item_1, alAgenda);
                ...
                Toast.makeText(Home.this, "Error " + ex.getMessage().toString(), Toast.LENGTH_SHORT).show();
            }
        ...
        protected void onPostExecute(String s){
            ...
            try {
                ...
                if (jsonObject1.getBoolean("ok")){
                    Toast.makeText(Home.this, "Registro Eliminado", Toast.LENGTH_SHORT).show();
                    Intent regresar = new Intent(Home.this, Home.class);
                    startActivity(regresar);
                }else {
                    Toast.makeText(Home.this, "Error al Eliminar Registro...", Toast.LENGTH_SHORT).show();
                }

            }catch (Exception ex){
                Toast.makeText(Home.this, "Error al enviar a la red", Toast.LENGTH_SHORT).show();
            }
